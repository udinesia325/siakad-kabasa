...
update.url = (
    ...
    const parsedArgs = {
        tahun_ajaran:
            typeof args.tahun_ajaran === 'object'
 ...
 */
export const setAktif = (
    args:
        | { tahunAjaran: number | { id: number } }
        | [tahunAjaran: number | { id: number }]
        | number
        | { id: number },
    options?: RouteQueryOptions,
...
setAktif.url = (
    ...
    const parsedArgs = {
        tahunAjaran:
            typeof args.tahunAjaran === 'object'
                ? args.tahunAjaran.id
                : args.tahunAjaran,
    };

    return (
        setAktif.definition.url
