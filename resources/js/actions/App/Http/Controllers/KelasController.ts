...
* @see app/Http/Controllers/KelasController.php:70
...
* @see app/Http/Controllers/KelasController.php:91
...
* @see app/Http/Controllers/KelasController.php:98
...
const KelasController = { index, store, update, destroy, naikKelas, luluskan, logOperasi }
