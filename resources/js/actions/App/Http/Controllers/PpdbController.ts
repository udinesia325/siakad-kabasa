 ...
 * @see app/Http/Controllers/PpdbController.php:81
 * @route '/ppdb/{ppdb}'
 */
const update2f389ca0f9a388fdf63f44a54db3c30e = (
    args:
        | { ppdb: number | { id: number } }
        | [ppdb: number | { id: number }]
        | number
        | { id: number },
    options?: RouteQueryOptions,
 ...
 * @route '/ppdb/{ppdb}'
 */
update2f389ca0f9a388fdf63f44a54db3c30e.url = (
    args:
        | { ppdb: number | { id: number } }
        | [ppdb: number | { id: number }]
        | number
    ...
    const parsedArgs = {
        ppdb: typeof args.ppdb === 'object' ? args.ppdb.id : args.ppdb,
    };

    return (
        update2f389ca0f9a388fdf63f44a54db3c30e.definition.url
 ...
 * @route '/ppdb/{ppdb}'
 */
update2f389ca0f9a388fdf63f44a54db3c30e.put = (
    args:
        | { ppdb: number | { id: number } }
        | [ppdb: number | { id: number }]
        | number
 ...
 * @route '/ppdb/{ppdb}'
 */
const update2f389ca0f9a388fdf63f44a54db3c30eForm = (
    args:
        | { ppdb: number | { id: number } }
        | [ppdb: number | { id: number }]
        | number
 ...
 * @route '/ppdb/{ppdb}'
 */
update2f389ca0f9a388fdf63f44a54db3c30eForm.put = (
    args:
        | { ppdb: number | { id: number } }
        | [ppdb: number | { id: number }]
        | number
...
update2f389ca0f9a388fdf63f44a54db3c30e.form =
    update2f389ca0f9a388fdf63f44a54db3c30eForm;
/**
 * @see \App\Http\Controllers\PpdbController::update
 * @see app/Http/Controllers/PpdbController.php:81
 * @route '/ppdb/{ppdb}'
 ...
 * @route '/ppdb/{ppdb}'
 */
update2f389ca0f9a388fdf63f44a54db3c30e.patch = (
    args:
        | { ppdb: number | { id: number } }
        | [ppdb: number | { id: number }]
        | number
 ...
 * @route '/ppdb/{ppdb}'
 */
update2f389ca0f9a388fdf63f44a54db3c30eForm.patch = (
    args:
        | { ppdb: number | { id: number } }
        | [ppdb: number | { id: number }]
        | number
 ...
 * @see app/Http/Controllers/PpdbController.php:114
 ...
 * @see app/Http/Controllers/PpdbController.php:97
 * @route '/ppdb/{ppdb}'
 */
...
const PpdbController = { index, store, update, aktivasi, destroy };
