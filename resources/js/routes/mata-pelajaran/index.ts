...
export const update = (
    args:
        | { mataPelajaran: number | { id: number } }
        | [mataPelajaran: number | { id: number }]
        | number
        | { id: number },
    options?: RouteQueryOptions,
...
update.url = (
    ...
    const parsedArgs = {
        mataPelajaran:
            typeof args.mataPelajaran === 'object'
...
const mataPelajaran = {
    ...
    syncPengampu: Object.assign(syncPengampu, syncPengampu),
};
