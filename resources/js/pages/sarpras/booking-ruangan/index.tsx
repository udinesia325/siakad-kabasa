...
export default function BookingRuanganIndex({
    booking,
    filters,
    lokasiList,
    authId,
    ...
    const canApprove =
        ...
        auth.permissions.some((p) =>
            p.startsWith('sarpras.booking-ruangan.approve'),
        );
            ...
            <div className="flex flex-col gap-4 p-4">
                ...
                {booking.last_page > 1 && (
                    <p className="text-sm text-muted-foreground">
                        Halaman {booking.current_page} dari {booking.last_page}{' '}
                        · {booking.total} total
                    </p>
                )}
            </div>
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <div className="flex flex-col gap-2">
                                ...
                                <Input
                                    ...
                                    onChange={(e) =>
                                        form.setData('mulai', e.target.value)
                                    }
                                />
                                {form.errors.mulai && (
                                    <p className="text-sm text-destructive">
            ...
            >
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            Ruangan:{' '}
                            <strong>{actionTarget?.item.lokasi?.nama}</strong>{' '}
                            oleh {actionTarget?.item.pemohon?.name}
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
